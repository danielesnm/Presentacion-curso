...
<br>
.pull-left[.bg-washed-blue.b--lightest-blue.ba.bw2.br3.shadow-5.ph4.mt5[
##Sociodemográficos:
- **Paciente:**
>- Sexo.
>- Edad.
...
- **Cuidador/a o familiar:** 
>- Sexo.
>- Edad.
>- Años de educación.
>- Relación con el paciente.
>- Si convive con él/ella.
>- Si no convive con qué frecuencia tiene contacto.
]
]

.pull-right[.bg-washed-green.b--light-green.ba.bw2.br3.shadow-5.ph4.mt5[
##Salud
- **Tiempo transcurrido desde el daño** (fecha daño, fecha evaluación)
- **Gravedad** (coma, amnesia- Glasgow, si hay dato)
- **Nivel de funcionalidad** (Barthel, Lawton si hay dato y fecha) 
- **Etiología daño** (ACV y tipo, TCE, tumor, proceso infeccioso, etc.).
- **Area cerebral afectada** (toda la información radiológica disponible).
]
